...
class DatabaseService {
  ...
  /// Retrieve databases and their tables in a single Rust/SQL round trip.
  Future<SchemaOverview> fetchSchemaOverview() async {
    return getMysqlSchemaOverview(url: url);
  }
